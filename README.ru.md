...
|---------|-------------|---------|--------|
| `rpaforge-core` | Движок, отладчик, JSON-RPC мост | v0.3.4 | ✅ Стабильный |
| `rpaforge-libraries` | 14 RPA-библиотек | v0.3.4 | ✅ Стабильный |
| `rpaforge-studio` | Electron + React десктопный UI | v0.3.4 | 🔄 Альфа |
...
### v0.3.4 — Онбординг и i18n *(текущая)*

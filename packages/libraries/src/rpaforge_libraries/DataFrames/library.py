...
class DataFrames:
    ...
    def _pl(self):
        try:
            ...
            raise ImportError(
                _(
                    "polars is required for DataFrames library. Install it with: pip install rpaforge-libraries[dataframes]"
                )
            ) from err
    ...
    @output("Name of the loaded DataFrame")
    def read_excel(
        self, path: str, frame_name: str = "df", sheet: str | None = None
    ) -> str:
    ...
    @output("Name of the resulting DataFrame")
    def select_columns(
        self, frame: str, columns: list, result_frame: str | None = None
    ) -> str:
    ...
    @output("Name of the resulting DataFrame")
    def rename_column(
        self, frame: str, old_name: str, new_name: str, result_frame: str | None = None
    ) -> str:
    ...
    @output("Name of the resulting DataFrame")
    def drop_nulls(
        self, frame: str, subset: list | None = None, result_frame: str | None = None
    ) -> str:

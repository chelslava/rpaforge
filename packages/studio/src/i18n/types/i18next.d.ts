  ...
  interface CustomTypeOptions {
    ...
    resources: {
      common: {
        ...
        help: { title: string; file: string; edit: string; canvas: string; run: string; debug: string };
        shortcuts: {
          newProcess: string;
          openProcess: string;
          saveProcess: string;
        ...
        blocks: {
          ...
          settings: { theme_light: string; theme_dark: string; theme_system: string };
        };
        blockDescriptions: {
          start: string;
          end: string;
        ...
        palette: {
          ...
          blocks: string;
          activities: string;
          quickStartTips: { builtin: string; webUI: string; desktopUI: string; excel: string };
          categories: {
            core: string;
            desktopUI: string;
            webUI: string;
        ...
        layout: { processDiagram: string; executing: string };
        debuggerPanel: {
          runtime: string;
          process: string;
          watch: string;
        ...
        callStack: { title: string; noCallStack: string; startDebugging: string; vars: string };
        breakpoints: {
          title: string;
          noBreakpoints: string;
          clickToAddBreakpoint: string;
        ...
        propertyEditors: {
          ...
          retryScope: { stopConditionPlaceholder: string };
          start: { processName: string; addTag: string; noTags: string; tagName: string; tagNamePlaceholder: string };
        };
        quickAdd: { searchActivities: string; escToClose: string; noActivities: string; navigate: string; enterSelect: string };
        diagramExplorer: {
          explorer: string;
          noProject: string;
          createProject: string;
        ...
        elementTree: { filterByTag: string; clickInspect: string; noMatchFilter: string };
        actionList: { actions: string; noActions: string; startRecording: string; export: string; deleteAction: string };
        selectorSpy: {
          title: string;
          web: string;
          desktop: string;
        ...
        codeEditor: {
          variablesPanel: { searchPlaceholder: string; addVariablesHint: string };
          snippetPanel: { searchPlaceholder: string };
          toolbar: { find: string; replace: string; formatCode: string; snippets: string; variables: string };
        };
        retryIntervals: { oneSecond: string; twoSeconds: string; fiveSeconds: string; tenSeconds: string; thirtySeconds: string; oneMinute: string };
        retry_scope: string;
        ...
        sidebar: { activities: string; diagrams: string; debugControls: string; variables: string; breakpoints: string; consoleSettings: string; consoleDescription: string };
        editableTextField: { openEditor: string };
        editor: { editValue: string };
        forEachBlockEditor: {
          itemVariable: string;
        ...
        ifBlockEditor: { condition: string; conditionPlaceholder: string };
        whileBlockEditor: { condition: string; maxIterations: string; maxIterationsHelp: string; timeout: string; timeoutHelp: string; bodyPort: string; bodyPortHelp: string; nextPort: string; nextPortHelp: string; conditionPlaceholder: string };
        inlineLoading: { loading: string };
        fieldHelp: { helpFor: string; format: string; examples: string };
        assign: { variableName: string; variableNamePlaceholder: string; variableType: string; expression: string; expressionPlaceholder: string; scope: string; processScope: string; taskScope: string; scopeHint: string };
        variablePicker: { noVariables: string };
        ...
        language_switcher: { english: string; russian: string };
        theme_switcher: { light: string; dark: string; system: string };
      };
      errors: {
        validation: { required: string; minLength: string; maxLength: string; email: string; url: string; number: string };
        network: { connectionLost: string; timeout: string; serverError: string };
        file: { notFound: string; accessDenied: string; invalidFormat: string };
        activity: { notFound: string; invalidConfiguration: string; executionFailed: string };
      };
      blocks: {
        start: string;
        end: string;
      ...
      builtin: { log: { title: string; description: string }; sleep: { title: string; description: string }; setVariable: { title: string; description: string } };
      desktopui: { openApplication: { title: string; description: string }; waitWindowState: { title: string; description: string }; inputText: { title: string; description: string } };
      webui: { openBrowser: { title: string; description: string }; navigateTo: { title: string; description: string }; clickElement: { title: string; description: string } };
      excel: { openWorkbook: { title: string; description: string }; readRange: { title: string; description: string }; writeRange: { title: string; description: string } };
      database: { createConnection: { title: string; description: string }; executeQuery: { title: string; description: string } };
      ocr: { recognizeText: { title: string; description: string } };
      credentials: { setPassword: { title: string; description: string }; getPassword: { title: string; description: string } };
      file: { readFile: { title: string; description: string }; writeFile: { title: string; description: string } };
      string: { concatenate: { title: string; description: string }; format: { title: string; description: string } };
      datetime: { getCurrentTime: { title: string; description: string }; formatTime: { title: string; description: string } };
      flow: { if: string; while: string; for: string; break: string; continue: string };
      http: { get: { title: string; description: string }; post: { title: string; description: string } };
      variables: { set: string; get: string; list: string; clear: string };
    };
  }
}
